        ...
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              ...
              child: Image.file(imageFile, width: double.infinity, height: 220, fit: BoxFit.cover),
            ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Icon(
                      result.isHealthy ? Icons.check_circle : (result.isNotLemon ? Icons.cancel : Icons.warning),
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: _severityColor),
                      ),
                    ),
                  ]),
                  ...
                  Row(children: [
                    ...
                    Text('${(result.confidence * 100).toStringAsFixed(1)}%',
                        style: TextStyle(fontWeight: FontWeight.bold, color: _severityColor)),
                  ]),
            ...
            if (treatment != null && treatment.treatment.isNotEmpty) ...[
              ...
              ...treatment.treatment.asMap().entries.map((e) =>
                _StepCard(step: e.key + 1, text: e.value, color: Colors.red[50]!, borderColor: Colors.red[200]!)),
              const SizedBox(height: 20),
            ],
            ...
            if (treatment != null && treatment.prevention.isNotEmpty) ...[
              ...
              ...treatment.prevention.map((tip) =>
                _BulletCard(text: tip, color: Colors.green[50]!, borderColor: Colors.green[200]!)),
              const SizedBox(height: 20),
            ],
...
class _StepCard extends StatelessWidget {
  ...
  const _StepCard({required this.step, required this.text, required this.color, required this.borderColor});
...
class _BulletCard extends StatelessWidget {
  ...
  final Color color;
  final Color borderColor;
  const _BulletCard({required this.text, required this.color, required this.borderColor});
