...
//   // ══════════════════════════════════════════════════════════
//   // UI — responsive: scales with screen width instead of fixed sizes
//   // ══════════════════════════════════════════════════════════
...
//     // Breakpoints: treat <360 as small phones, >600 as tablets.
...
//           // Cap content width on tablets/large screens so it doesn't stretch edge to edge.
//           constraints: BoxConstraints(maxWidth: isTablet ? 640 : double.infinity),
//           child: Column(
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               _buildTopBar(lang, width),
//               const SizedBox(height: 22),
//               _buildHeroImage(lang, width),
//               const SizedBox(height: 10),
//               _buildDots(),
//               const SizedBox(height: 22),
//               Text(
//                 lang.t(
//                   ' Lemon Leaf Detection ',
...
//               _buildActionButtons(lang, width),
//               const SizedBox(height: 24),
//               _buildFeatureCards(lang, width),
//               const SizedBox(height: 12),
//             ],
//           ),
//         ),
...
//   Widget _buildTopBar(LanguageProvider lang, double width) {
//     final isSmall = width < 360;
//     final logoSize = isSmall ? 68.0 : (width < 400 ? 84.0 : 100.0);
//     final titleFontSize = isSmall ? 15.0 : (width < 400 ? 17.0 : 19.0);
...
//             height: logoSize,
//             fit: BoxFit.cover,
//             // If the asset is missing, fall back to the lemon emoji
//             // instead of crashing.
//             errorBuilder: (context, error, stackTrace) =>
//                 Text('', style: TextStyle(fontSize: logoSize * 0.44)),
//           ),
//         ),
...
//         _buildLangToggle(lang, isSmall),
//       ],
//     );
//   }

//   Widget _buildLangToggle(LanguageProvider lang, bool isSmall) {
//     return Container(
...
//           children: [
//             _langSegment('EN', !lang.isNepali, isSmall),
//             _langSegment('ने', lang.isNepali, isSmall),
//           ],
//         ),
//       ),
//     );
...
//   Widget _langSegment(String label, bool active, bool isSmall) {
//     return Container(
...
//   Widget _buildHeroImage(LanguageProvider lang, double width) {
//     final isSmall = width < 360;
//     final heroHeight = (width * 0.52).clamp(170.0, 240.0);
//     final sideBadgeWidth = isSmall ? 92.0 : 108.0;
//     // On very narrow screens the right-side detail card gets tight;
//     // trim its inner spacing instead of hiding content.
//     final badgePad = isSmall ? 9.0 : 12.0;
...
//                       Text(
//                         lang.t('LEMON LEAF SCANNING', 'कागती पात स्क्यानिङ'),
//                         style: TextStyle(
//                           color: Colors.white,
...
//   Widget _buildActionButtons(LanguageProvider lang, double width) {
//     final isSmall = width < 360;
//     return Row(
//       children: [
//         Expanded(
...
//   // ── Feature cards — 3-in-a-row on normal/tablet screens, wraps to
//   // a 2-column grid on narrow phones so text never gets squeezed ────
//   Widget _buildFeatureCards(LanguageProvider lang, double width) {
//     final cards = [
//       _FeatureCard(
...
//     // Narrow phones: 2 cards per row (3rd card takes the second row,
//     // full width) instead of squeezing 3 into one row.
//     if (width < 360) {
//       return Column(
//         children: [
//           Row(
